...
KAGLE_FILE_LINE_SENTANCE='./tempfolder/trainAndUnalbed'
KAGLE_FILE_TRAIN_W2V_LINE_SENTANCE= './tempfolder/train_LINE_SENTANCE'
KAGLE_FILE_TRAIN_IVECTOR_LINE_SENTANCE='./tempfolder/trainAndUnalbed_imdb'
KAGLE_W2V_MODEL='./tempfolder/trainAndUnalbed.w2v.20.bin'
