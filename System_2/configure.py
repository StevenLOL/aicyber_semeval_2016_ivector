...
IMDB_FILE_TEST= './imdb/testData.tsv'
IMDB_FILE_TEST_LINE_SENTANCE= './tempfolder/imdb_test_line_sentance'
IMDB_FILE_ALL_LINE_SENTANCE= './tempfolder/imdb_all_train_unlabled_line_sentance'
IMDB_FILE_TRAIN_W2V_LINE_SENTANCE= './tempfolder/imdb_train_line_sentance'
IMDB_FILE_TRAIN_IVECTOR_LINE_SENTANCE=IMDB_FILE_ALL_LINE_SENTANCE
IMDB_W2V_MODEL= './tempfolder/imdb_trained_75000.w2v.20.bin'
